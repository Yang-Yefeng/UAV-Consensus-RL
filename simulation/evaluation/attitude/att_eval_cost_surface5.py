...
if __name__ == '__main__':
    ...
    # opt_path = env.project_path + 'datasave/log/att_train_draw_only/trainNum_3100/'
    opt_path = env.project_path + 'datasave/log/att_train_draw_only_stage_3/trainNum_2220/'
    ...
    pd.DataFrame(cost, columns=['A', 'T', 'rl_no_obs', 'smc_no_obs', 'rl_obs', 'smc_obs']).to_csv(save_path + 'att_cost_surface_3_2220.csv', sep=',', index=False)
