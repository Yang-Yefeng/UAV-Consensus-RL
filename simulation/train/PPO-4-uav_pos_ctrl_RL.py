...
from environment.envs.uav_pos_ctrl.uav_pos_ctrl_RL import uav_pos_ctrl_RL, uav_param
...
if __name__ == '__main__':
    ...
    env.reset_env(random_pos_trajectory=False, yaw_fixed=False, new_pos_ctrl_param=att_ctrl_param, outer_param=None)
    ...
    while True:
        ...
        if t_epoch % 10 == 0 and t_epoch > 0:
            ...
            for i in range(n):
                ...
                env_test.reset_env(random_pos_trajectory=False,  # 等幅
                                   yaw_fixed=False,
                                   random_pos0=False,
                                   new_pos_ctrl_param=pos_ctrl_param,
                                   outer_param=p)
